...
typedef struct
{
	...
	uint16_t Voltage;//0-65535 mV
	short Current;//-32768-32767
	char BatteryTemperature;//-128 -127
	uint16_t BatteryCharge;//0-65535 mAh
	uint16_t BatteryCapacity;//0-65535 mAh
	uint16_t WallSignal; //0-4095
	uint16_t CliffLeftSignal; //0-4095
	uint16_t CliffFrontLeftSignal;//0-4095
	uint16_t CliffFrontRightSignal;//0-4095
	uint16_t CliffRightSignal;//0-4095
	...
	uint16_t CargoBayAnalogSignal;//0-1023
